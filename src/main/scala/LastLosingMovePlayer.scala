import benjamingarrett.rockpaperscissorstools.{AWins, BWins, Paper, RPSHistoryBasedPlayer, RPSMove, RPSOutcome, Rock, Scissors}

import scala.util.Random

class LastLosingMovePlayer extends RPSHistoryBasedPlayer{
